...
import com.google.samples.apps.codechallenge.fragment.QuizFragment;
import com.google.samples.apps.codechallenge.helper.ApiLevelHelper;
import com.google.samples.apps.codechallenge.helper.ViewUtils;
...
import com.google.samples.apps.codechallenge.widget.TextSharedElementCallback;

import java.util.List;

import static com.google.samples.apps.codechallenge.adapter.CategoryAdapter.DRAWABLE;
...
public class QuizActivity extends AppCompatActivity {
    ...
    private void populate(String categoryId) {
        ...
        mCategory = CodeChallengeDatabaseHelper.getCategoryWith(this, categoryId);
